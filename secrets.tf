...
#   }))
#   default = [
#       { project = "smart_credit", name = "database", type = "string", environment = "prod", secret_values = "smart-credit-prod" },
#       { project = "smart_credit", name = "username", type = "string", environment = "prod", secret_values = "smartcreditdb_prod" },
#       { project = "smart_credit", name = "password", type = "string", environment = "prod", secret_values = "undergo-marvelous-residency-emptiness-dazzler" },


#       { project = "camunda", name = "database", type = "string", environment = "prod", secret_values = "camunda-prod" },
#       { project = "camunda", name = "username", type = "string", environment = "prod", secret_values = "camundadb_prod" },
#       { project = "camunda", name = "password", type = "string", environment = "prod", secret_values = "outer-express-carport-rocket-frenzied" },


#       { project = "workflow", name = "database", type = "string", environment = "prod", secret_values = "workflow-prod" },
#       { project = "workflow", name = "username", type = "string", environment = "prod", secret_values = "workflowdb_prod" },
#       { project = "workflow", name = "password", type = "string", environment = "prod", secret_values = "aptly-wafer-pushiness-foothill-cupcake" }      
#     ]
# }
